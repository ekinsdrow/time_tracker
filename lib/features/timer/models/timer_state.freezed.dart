...
class _$_TimerState implements _TimerState {
  ...
  @override
  String toString() {
    return 'TimerState(timerState: $timerState, startTime: $startTime, categoryLeaf: $categoryLeaf)';
  }
...
abstract class _TimerState implements TimerState {
  factory _TimerState(
      {required final TimerStateEnum timerState,
      required final DateTime? startTime,
      required final CategoryLeaf? categoryLeaf}) = _$_TimerState;
